            ...
            <form action="../PHP/EditUsu.php" class="formulario" id="formulario" method="post" enctype="multipart/form-data">
                ...
                <li>
                    <div class="formulario__grupo" id="grupo__nombre">
                        ...
                        <div class="formulario__grupo-input">
                            <input name="Nombres" id="Nombres" class="formulario__input" type="text" placeholder="Nombre completo" value="<?php echo htmlspecialchars($nombres); ?>">
                            <span class="material-symbols-rounded">cancel</span>
                            <p class="formulario__input-error">El nombre solo puede contener letras y espacios en blanco.</p>
                        </div>
                    </div>
                    ...
                    <div class="formulario__grupo" id="grupo__apellido">
                        ...
                        <div class="formulario__grupo-input">
                            <input name="Apellidos" id="Apellidos" class="formulario__input" type="text" placeholder="Apellidos" value="<?php echo htmlspecialchars($apellidos); ?>">
                            <span class="material-symbols-rounded">cancel</span>
                ...
                <li>
                    <div class="formulario__grupo" id="grupo__Fecha_Nacimiento">
                        ...
                        <div class="formulario__grupo-input">
                            <input name="FechadeNacimiento" id="FechadeNacimiento" class="formulario__input" type="date" value="<?php echo $fechaNac; ?>">
                            <span class="material-symbols-rounded">cancel</span>
                            <p class="formulario__input-error">La fecha de nacimiento no puede ser despues del dia actual.</p>
                        </div>
                    </div>
                    ...
                    <div class="formulario__grupo" id="grupo__correo">
                        ...
                        <div class="formulario__grupo-input">
                            <input name="CorreoElectrónico" id="CorreoElectrónico" class="formulario__input" type="text" placeholder="ejemplo@gmail.com" value="<?php echo htmlspecialchars($correo); ?>">
                            <span class="material-symbols-rounded">cancel</span>
                            <p class="formulario__input-error">El correo electrónico debe tener un formato como el del ejemplo: ejemplo@gmail.com</p>
                        </div>
                    </div>
                </li>
                ...
                <li>
                    <div class="formulario__grupo" id="grupo__Genero">
                        ...
                        <div class="formulario__grupo-input">
                            <input type="radio" name="genero" value="M" <?php echo ($genero == 'M') ? 'checked' : ''; ?>> Masculino
                            <input type="radio" name="genero" value="F" <?php echo ($genero == 'F') ? 'checked' : ''; ?>> Femenino
                            <span class="material-symbols-rounded">cancel</span>
                            <p class="formulario__input-error">No se ha escogido un género.</p>
                        </div>
                    </div>
                </li>
                ...
                <li>
                    <div class="formulario__grupo" id="grupo__Imagen_perfil">
                        ...
                        <div class="formulario__grupo-input">
                            ...
                            <span class="material-symbols-rounded">cancel</span>
                            <p class="formulario__input-error">Extensión no permitida. Utiliza: .jpeg/.jpg/.png/.</p>
                        </div>
                    </div>
                    ...
                    <div class="formulario__grupo" id="grupo__nombre_usuario">
                        ...
                        <div class="formulario__grupo-input">
                            <input name="NombredeUsuario" id="NombredeUsuario" class="formulario__input" type="text" placeholder="Nombre de Usuario" value="<?php echo htmlspecialchars($nombreUsuario); ?>">
                            <span class="material-symbols-rounded">cancel</span>
                ...
                <li>
                    ...
                    <div class="formulario__grupo" id="grupo__confirmar_contraseña">
                        ...
                        <div class="formulario__grupo-input">
                            ...
                            <span class="material-symbols-rounded">cancel</span>
                            <p class="formulario__input-error">La confirmacion no coincide con la contraseña introducida.</p>
                        </div>
                    </div>
                </li>
                <li>
                    <input type="radio" name="privacidad" value=0 <?php echo $priv === 0 ? 'checked' : ''; ?>> Publico
                    <input type="radio" name="privacidad" value=1 <?php echo $priv === 1 ? 'checked' : ''; ?>> Privado
                </li>
                <?php
                    }
                ?>
    ...
    <footer>
        <div class="footer_container">
            <div class="footer_box">
                ...
                <div class="terminos">
                    <p>La Empresa En Sí Es Una Empresa Muy Exitosa. ¿A Él El Placer De Las Penas, La Culpa De Los Placeres Fáciles, Resultarán De La Ganancia, Ni Le Explicaré Las Veces Que Quiere Del Odio, O Es Menor En Otras Ocasiones? Ciertamente Así Es.</p>
                </div>
            </div>
